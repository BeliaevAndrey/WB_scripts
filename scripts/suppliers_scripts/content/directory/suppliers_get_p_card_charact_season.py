...
URL = "https://suppliers-api.wildberries.ru/content/v1/directory/seasons"


async def a_get_supp_product_category_season() -> tuple | dict:
    headers_dict = {
...
if __name__ == '__main__':
    ...
    pprint.pp(asyncio.run(a_get_supp_product_category_season()))
