...
URL = "https://suppliers-api.wildberries.ru/content/v1/directory/kinds"


async def a_get_supp_product_category_gender() -> tuple | dict:
    headers_dict = {
...
if __name__ == '__main__':
    import pprint
    pprint.pp(asyncio.run(a_get_supp_product_category_gender()))
